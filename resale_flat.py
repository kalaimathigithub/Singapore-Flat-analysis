...
def predict_price(year,town,flat_type,flr_area_sqm,flat_model,stry_start,stry_end,re_les_year,
    ...
    flr_ar_sqm_1= np.log(int(flr_area_sqm))
    ...
    with open(r"E:\python\Project_6\Project_7\Resale_Flat_Prices_Model_1.pkl","rb") as f:
...
if select == "Home":
    img= Image.open(r"E:\python\Project_6\Project_7\-1x-1.jpg")
    st.image(img)
